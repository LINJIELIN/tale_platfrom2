<template>
  <div align="center">
    ...
    <div class="demo-input-suffix" style="position:relative;left:-5%;">
      ...
      <el-select v-model="inputSort" placeholder="请选择">
        <el-option
    ...
    <div align="center">
      <el-table :data="lost" border  id="tableWidth" class="table" :header-cell-style="{'text-align':'center'}">
        ...
        <!--</el-table-column>-->
        <el-table-column prop="location" label="失物地点" width="100" font-size="8px" >
        </el-table-column>
        <el-table-column prop="lostTime" label="失物时间" width="100" font-size="8px" >
        </el-table-column>
  ...
  export default {
    ...
    mounted:function(){
      ...
      methods: {
        getData(){
            ...
            axios.get("http://localhost:8082/sort",{
              ...
              if (res.data.code == 0) {
                ...
                _this.optionsSort = res.data.data;
              } else {
              }
            });
        },
        ...
        getAllPage:function(){
          let _this = this;
          console.log(this.inputSort);
          axios.get("http://localhost:8082/lost/list",{
            params:{
          ...
          axios.get("http://localhost:8082/lost/"+ index)
            .then((response) => {
              ...
              if (resDate.code == "0") {
                ...
                this.type = resDate.data.sort.id;
