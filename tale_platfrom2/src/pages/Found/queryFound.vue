  ...
  <div align="center">
    ...
    <div align="center">
      <el-table :data="found" border id="tableWidth" class="table" :header-cell-style="{'text-align':'center'}">
        ...
        <!--<el-table-column prop="sort" label="类型" width="70"align="center">-->
        <!--</el-table-column>-->
                ...
                <div>
                  <div style="margin-left:-51px;">
                    ...
                    <span style="font-weight:bold;">
                      <el-select v-model="sort" placeholder="请选择" style="width:200px;">
                          <el-option
      ...
      getData(){
        ...
        axios.get("http://localhost:8082/sort",{
          ...
          if (res.data.code == 0) {
            ...
            _this.selectSort = res.data.data;
          } else {
          }
        });
      },
          ...
          .then((response) => {
            ...
            if (resDate.code == "0") {
             // console.log(resDate.data)
              ...
              this.sort = resDate.data.sort.name;
